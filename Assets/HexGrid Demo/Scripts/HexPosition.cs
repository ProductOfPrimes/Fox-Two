...
public class HexPosition : System.IEquatable<HexPosition>
{
    ...
    public string SelectedType
    {
        ...
        private set
        {
            ...
            {
                thisMarker = (GameObject)Object.Instantiate(marker, getPosition() + new Vector3(0f, 0.01f * layer, 0f), Quaternion.Euler(0, 30, 0));
                thisMarker.GetComponent<Renderer>().material.color = color;
